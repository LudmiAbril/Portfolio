...
const Footer = () => {
  ...
  return (
    <div className='py-5 px-[28px] bg-footer-background text-footer-text text-center flex flex-col gap-5 lg:flex-row lg:justify-between lg:px-[80px]'><p>Ludmila Pereyra © {new Date().getFullYear()}</p>
