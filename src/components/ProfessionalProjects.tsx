...
const ProfessionalProjects = () => {
    ...
    return (
        <div className='flex flex-col items-center min-h-screen scroll-mt-40' id='projects'>
            <motion.h1 className="flex flex-col font-title text-4xl font-medium mb-15 text-center lg:inline lg:text-5xl lg:mb-30" variants={textVariants} initial="hidden"
                whileInView="visible"
